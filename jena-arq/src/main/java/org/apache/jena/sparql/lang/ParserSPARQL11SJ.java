...
public class ParserSPARQL11SJ extends SPARQLParser
{
    private interface Action { void exec(SPARQLParser11SJ parser) throws Exception ; }
    
    @Override
    protected Query parse$(final Query query, String queryString)
    {
        query.setSyntax(Syntax.syntaxSPARQL_11sj) ;
        Action action = new Action() {
            @Override
            public void exec(SPARQLParser11SJ parser) throws Exception
            {
                parser.QueryUnit() ;
            }
        } ;
    ...
    private static void perform(Query query, String string, Action action)
    {
        ...
        SPARQLParser11SJ parser = new SPARQLParser11SJ(in) ;
        ...
        {
            Log.warn(ParserSPARQL11SJ.class, "Unexpected throwable: ",th) ;
